...
from myagent.tools.tool_filter import ReadOnlyFilter, FullAccessFilter
...
class MockSimpleAgent(Agent):
    ...
    def __init__(self, name: str, llm: AgentLLM, config: Config = None, tool_registry: ToolRegistry = None):
